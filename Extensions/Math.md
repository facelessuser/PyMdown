...
The math extension actually converts the dollar notation to a more reliable notation in the HTML.  So the conversion is as follows: `$...$` -> `\(...\)` and `$$...$$` -> `\[...\]`.  Keep this in mind when configuring MathJax for your document.
